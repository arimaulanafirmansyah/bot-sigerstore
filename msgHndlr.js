    ...
    switch (command) {
      ...
      case '!sgif':
        if (isMedia) {
          ...
          } else client.reply(from, '[❗] Kirim video dengan caption *!stickerGif* max 10 sec!', id);
        }
        break;
      case '!stickernobg':
      case '!stikernobg':
      ...
      case '!ytmp3':
        ...
        try {
          ...
          if (resp.error) {
            ...
            if (Number(filesize.split(' MB')[0]) >= 30.0) return client.reply(from, 'Maaf durasi video sudah melebihi batas maksimal!', id);
      ...
      case '!ytmp4':
        ...
        try {
          ...
          if (ytv.error) {
            ...
            if (Number(ytv.filesize.split(' MB')[0]) > 40.0) return client.reply(from, 'Maaf durasi video sudah melebihi batas maksimal!', id);
